...
```{r, include=FALSE}
# Read csv file ----------------------------------------------------------------
lu <- read.table(paste0(envrmt$path_data_csv, "AI001_gebiet_flaeche_bereinigt.csv"),
                 header = TRUE, sep = ";", dec = ",")

cp <- read.table(paste0(envrmt$path_data_csv, "115-46-4_feldfruechte_bereinigt.csv"),
                 header = TRUE, sep = ";", dec = ",")
